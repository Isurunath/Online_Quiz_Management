<div class="panel panel-post-item" style="align-items: center">
    ...
    <?php if(isset($data)) {
        ...
        if ($data == 0) {
            ?>
            <img style="margin-left: 220px;" class="img-circle img-responsive" src="../Profile_Pictures/default.png" width="200px" height="200px" alt="">
        <?php } else if ($data == 1) {
            ?>
            <img style="margin-left: 220px;" class="img-circle img-responsive" src="../Profile_Pictures/<?php echo $id ?>.jpg" width="200px" height="200px" alt="">
        <?php }
    }else {
        ...
        if ($Pic == 0) {
            ?>
            <img class="img-circle" src="../Profile_Pictures/default.png" width="200px" height="200px">
            <?php
        } else if ($Pic == 1) {
            ?>
            <img class="img-circle" src="../Profile_Pictures/<?php echo $id ?>.jpg" width="200px" height="200px">
            <?php
        }
    }
    ?>
    ...
    <?php echo "<input type='file' name='userfile' size='20' class='form-control' style='left: 200px;'/>"; ?>
