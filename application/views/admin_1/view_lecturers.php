            ...
            <div class="outter-wp">
                ...
                <div class="sub-heard-part">
                    <ol class="breadcrumb m-b-0">
                        ...
                        <li class="active">View registered lecturers</li>
                    </ol>
                </div>
                <!--/sub-heard-part-->
                                ...
                                <div class="modal fade" id="Modal" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post" onSubmit="window.location.reload()" name="form_layout" action="<?php echo site_url ('View_Lecturers/delete_lecturer'); ?>" class="form-horizontal">
