                                            ...
                                            <table style='padding-left:10px; color: #0b0b0b' >
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-8">
                                                        <br>
                                                        &nbsp;&nbsp;
                                                        <button type="submit" class="btn btn-default" style="margin-right: 300px" name="review" id="review" title="Download the PDF of Paper Review" onclick="">PDF Version - Review Of The Paper</button>
                                                    </div>
                                                </div>
